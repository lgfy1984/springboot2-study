package com.lmy.commons.aspect;
...
import com.lmy.commons.annotation.Check;
import com.lmy.commons.enums.CommonEnum;
import com.lmy.commons.result.ResultBody;
import com.lmy.commons.util.ReflectionUtil;
...
public class CheckParamAspect {
	 ...
	 */
	@Pointcut("@annotation(com.lmy.commons.annotation.Check)")
	 ...
	 * @throws Throwable
	 */
    @Around(value = "@com.lmy.commons.annotation") // 这里要换成自定义注解的路径
